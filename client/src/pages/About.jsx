  ...
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-4 text-slate-800">
        About EdisonPrise Estate
      </h1>
      <p className="mb-4 text-slate-700">
        EdisonPrise Estate is a leading real estate agency that specializes in
      ...
      <p className="mb-4 text-slate-700">
        ...
        of the local market. Wether you are looking to buy, sell, or rent a
